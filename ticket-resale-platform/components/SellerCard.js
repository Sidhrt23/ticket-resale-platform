...
export default function SellerCard({ seller, eventDate }) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      <div className="p-6">
        <h2 className="text-xl font-semibold mb-2 text-gray-800">{seller.name}</h2>
        <div className="space-y-2 mb-4">
          ...
          <div className="flex items-center text-gray-600">
            ...
            <span>{seller.tickets_available} tickets available</span>
          </div>
        </div>
        
        {/* Simplified WhatsApp button to avoid syntax errors */}
        <a 
          href={whatsappLink}
          target="_blank"
